...
type LoadSnapshotRequest struct {
	...
	DisableCrc           bool     `protobuf:"varint,6,opt,name=DisableCrc,proto3" json:"DisableCrc,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LoadSnapshotRequest) GetDisableCrc() bool {
	if m != nil {
		return m.DisableCrc
	}
	return false
...
var fileDescriptor_a73317e9fb8da571 = []byte{
	...
	,
}
